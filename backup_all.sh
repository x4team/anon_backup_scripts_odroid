...
EXCLUDE_CONF="/srv/dev-disk-by-label-DOCUMENTS/anon/odroid/backup/exclude.files.conf"

# Store todays date
NOW=$(date +"%F"_"%H"-"%M")
BKDIR="monthly"
BACKUPDIR="/srv/dev-disk-by-label-DOCUMENTS/anon/odroid/backup/$BKDIR"
...
# Store backup path
LAST_MONTH="/srv/dev-disk-by-label-DOCUMENTS/anon/odroid/backup/last_month"
